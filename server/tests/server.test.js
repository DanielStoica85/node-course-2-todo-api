...
describe('PATCH /todos/:id', () => {
	...
	it('should not update the todo not created by this user', (done) => {
...
describe('POST /users', () => {
	...
	it('should create a user', (done) => {
		...
		request(app)
			...
			// .end(done);
			// instead of ending the test here, we make db assertions if succeeded
			.end((err) => {
				if (err) {
					done(err);
				}
